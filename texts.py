# --- Текстовые константы и шаблоны сообщений с эмодзи ---
...
# Сообщения для управления админами
...
# Сообщения для управления учителями
...
# Общие тексты ошибок для админки/управления
